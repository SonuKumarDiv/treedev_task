...
class show_lib_data(serializers.ModelSerializer):
    class Meta():
        model=account_models.library_info
        fields=('library_name','country_code','phone_number','address','book_details','book_issu_by')
        depth=1

class create_users_form(serializers.Serializer):
    class Meta():
        model=account_models.Users
        fields=('__all__')
